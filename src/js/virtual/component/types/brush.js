...
const hasBandBrushFactory =
  ...
  (state = {}) => {
    ...
    const onBrush = (event) => {
      ...
      const d = d0 === null || d0 === dc || d1 === null ? null : [d0, d1];
      const change =
        bandDomain !== null
        ...
        if (bandMinStep !== null || bandMaxStep !== null) {
          const step = !d
            ...
            : fnScaleL
                ...
                .reduce(
                  (acc, f, i) =>
                    f === d[0] ? acc - i : f === d[1] ? acc + i : acc,
                  0
                );

          update =
            !(bandMinStep !== null) || (step !== null && step >= bandMinStep);
          update =
            update &&
            (!(bandMaxStep !== null) || step === null || step <= bandMaxStep);
        }
    ...
    const onEnd = (event) => {
      ...
      self.group().datum(bandDomain).dispatch("endBandDomain");
    };
